 ...
 */
#[Fillable(['pharmacy_id', 'email', 'role', 'invited_by', 'expires_at', 'accepted_at'])]
class PharmacyInvitation extends Model
{
    /** @use HasFactory<PharmacyInvitationFactory> */
    use HasFactory;
    ...
    protected static function boot(): void
    {
        ...
        static::creating(function (PharmacyInvitation $invitation) {
    ...
    /**
     * Get the pharmacy that the invitation belongs to.
     *
